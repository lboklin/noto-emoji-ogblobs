...
SELECTED_FLAGS = AC AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ \
	...
	ZA ZM ZW \
        ...
        CA-SK CA-NU US-MS US-CA CA-NT US-WI US-ID US-OK \
        US-WV US-CT US-CO US-AL CA-YT US-NJ US-GA US-AZ \
        US-NM US-NC US-KS US-AR CA-NL US-TN US-OH CA-AB \
        US-KY US-TX US-SC US-WA US-IL US-NH US-AK US-VT \
        CA-NS US-FL US-MA US CZ US-MO CA MG US-UT US-PA \
